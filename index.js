...
$(document).ready(function() {
	...
	$('#registerUser').click(function(){
		...
		sacv4.asyncRequest(dataItems,function(data){
	...
	$('#loginUser').click(function(){
		...
		var data = sacv4.syncLogin($('#loginUser-username').val(),$('#loginUser-password').val());
		if (! data.authOK) {
